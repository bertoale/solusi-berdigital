    ...
    <div className="max-w-5xl space-y-8">
      ...
      <div>
        ...
        >
          ...
          <span>Kembali ke Blog & Artikel</span>
        </Link>
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            <h1 className="theme-text text-2xl sm:text-3xl font-extrabold tracking-tight text-foreground flex items-center gap-2.5">
              ...
              <span>Kelola Kategori Blog</span>
            </h1>
            <p className="text-xs text-muted-foreground mt-0.5">
              Kelola kategori topik artikel dan wawasan bisnis digital untuk website publik.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-5 theme-card bg-card/95 backdrop-blur-md p-6 space-y-5">
          ...
          <AdminForm
            action={createBlogCategoryAction}
            successMessage="Kategori blog berhasil ditambahkan"
            loadingMessage="Menyimpan kategori..."
            className="space-y-4"
          >
            <div className="space-y-1.5">
              ...
              <input
                ...
                name="name"
                required
                placeholder="Contoh: Strategi Digital & SEO"
            ...
            <div className="space-y-1.5">
              ...
              <input
                type="text"
                name="slug"
                placeholder="strategi-digital (otomatis jika kosong)"
            ...
            <div className="space-y-1.5">
              ...
              <textarea
                name="description"
                rows={3}
                placeholder="Deskripsi ruang lingkup pembahasan artikel dalam kategori ini..."
            ...
            >
              ...
              <span>Simpan Kategori Blog</span>
            </Button>
          </AdminForm>
        </div>
            ...
            {categories.map((cat) => (
              ...
              >
                ...
                <div className="flex items-center gap-1.5 shrink-0 pt-0.5">
                  <Link
                    href={`/admin/blog/kategori/${cat.id}/edit`}
                  ...
                  <AdminDeleteButton
                    action={deleteBlogCategoryAction.bind(null, cat.id)}
                    itemTitle={cat.name}
                    title="Hapus Kategori"
                    className="p-2 rounded-lg bg-destructive/10 text-destructive hover:bg-destructive hover:text-destructive-foreground border border-destructive/20 font-bold transition-all cursor-pointer disabled:opacity-50"
                  />
                </div>
              </div>
            ))}
