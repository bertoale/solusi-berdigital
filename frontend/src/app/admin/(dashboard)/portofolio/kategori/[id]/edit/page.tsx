...
import { getPortfolioCategoryById } from "@/lib/data-store";
import { updatePortfolioCategoryAction } from "@/lib/actions";
...
export default async function AdminPortfolioCategoryEditPage({ params }: Props) {
  ...
  const updateActionWithId = updatePortfolioCategoryAction.bind(null, category.id);
  ...
  return (
    <div className="max-w-2xl space-y-6">
      ...
      <AdminForm
        ...
        redirectUrl="/admin/portofolio/kategori"
        className="theme-card bg-card/95 backdrop-blur-md p-6 sm:p-8 space-y-5"
      >
