            ...
            <tbody className="divide-y divide-border">
              {blogs.map((blog) => (
                <tr key={blog.id} className="hover:bg-muted/40 transition-colors">
                  <td className="px-6 py-4 font-semibold text-foreground max-w-sm">
                    ...
                    <div className="flex items-center justify-end gap-2">
                      ...
                      >
                        <button
                          type="submit"
                          title="Hapus Artikel"
                          className="theme-btn p-2 rounded-xl bg-destructive/10 text-destructive hover:bg-destructive/20 transition-colors cursor-pointer"
                        >
