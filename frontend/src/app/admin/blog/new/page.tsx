    ...
    <div className="max-w-4xl space-y-6">
      ...
      <div>
        ...
        <p className="text-xs text-muted-foreground mt-0.5">
          Buat artikel panduan bisnis digital, upload gambar cover ke S3, dan tulis konten menggunakan rich text editor Tiptap.
        </p>
      </div>

      {/* Create Form */}
      <form action={createBlogAction} className="theme-card bg-card/95 backdrop-blur-md p-6 sm:p-8 space-y-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <div className="space-y-1.5">
            ...
            <input
              type="text"
              name="slug"
              placeholder="alasan-website-profil-tender (otomatis jika kosong)"
          ...
          <div className="space-y-1.5 sm:col-span-2">
            ...
            <textarea
              ...
              required
              rows={2}
              placeholder="Ringkasan 1-2 kalimat untuk meta description dan kartu preview..."
          ...
          <div className="space-y-1.5 sm:col-span-2">
            ...
            <TiptapEditor
              name="content"
              initialContent="<p>Mulai tulis isi artikel wawasan bisnis digital Anda di sini...</p>"
            />
          </div>
