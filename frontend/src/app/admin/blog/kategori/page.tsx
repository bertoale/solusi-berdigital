    ...
    <div className="max-w-5xl space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-5 theme-card bg-card/95 backdrop-blur-md p-6 space-y-5">
          ...
          <form action={createBlogCategoryAction} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <input
                ...
                name="name"
                required
                placeholder="Contoh: AI & Otomasi Bisnis"
            ...
            <div className="space-y-1.5">
              ...
              <input
                type="text"
                name="slug"
                placeholder="ai-otomasi-bisnis (otomatis jika kosong)"
            ...
            <div className="space-y-1.5">
              ...
              <textarea
                name="description"
                rows={3}
                placeholder="Deskripsi topik bahasan dalam kategori ini..."
        ...
        <div className="lg:col-span-7 theme-card bg-card overflow-hidden">
          ...
          <div className="divide-y divide-border">
            {categories.map((cat) => {
              const deleteActionWithId = deleteBlogCategoryAction.bind(null, cat.id);
